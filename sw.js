...
const FILES = ["./", "./index.html", "./icon-192.png", "./icon-512.png",
  ...
  "./lottie/1-golden-sitting.json", "./lottie/2-golden-happy.json", "./lottie/3-golden-puppy.json", "./lottie/4-splashing.json", "./lottie/5-corgi.json", "./lottie/6-shiba.json", "./lottie/7-frenchie.json", "./lottie/8-golden-napping.json", "./lottie/9-poodle.json", "./lottie/pour-waterfall.json"];
